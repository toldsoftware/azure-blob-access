    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    log('loadImage START');
                    return [4 /*yield*/, load_image_1.loadImage(imageDataUri, { maxWidth: maxWidth, maxHeight: maxHeight })];
                case 1:
                    cvs = _a.sent();
                    log('loadImage END');
                    log('toDataURL START');
...
function uploadImage_manual(access, blobSasUrl, imageDataUri, maxWidth, maxHeight) {
    var _this = this;
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            try {
                                ...
                                scale = maxHeight == null ? maxWidth / img_1.width : Math.min(maxWidth / img_1.width, maxHeight / img_1.height);
                                if (scale > 1) {
                                    scale = 1;
                                }
...
exports.uploadImage_manual = uploadImage_manual;
